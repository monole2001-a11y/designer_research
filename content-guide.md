...
| 저비용 쉐어하우스 생활비 2년 | $52,000–$72,000 | Queens, Brooklyn 외곽, Upper Manhattan 룸 쉐어 + 대중교통 통학 가정 |
| 보험·재료·정착비 | $8,000–$12,000 | 버퍼성 비용 |
| 장학금 반영 후 순현금 필요액 | $101,000–$125,000 | 학비 잔액 + 생활비 + 기타 비용 |
| 저비용 거주 시나리오 순현금 필요액 | $83,000–$107,000 | 동일 기타 비용 가정 시 기본 시나리오 대비 약 $18K 절감 |
...
**거주비 절감 시나리오:** SpareRoom Q1 2026 평균 룸렌트 기준 Manhattan $1,832, Brooklyn $1,454, Queens $1,242, Bronx $1,169/month. MTA OMNY 7일 fare cap $34 기준 월 교통비는 약 $136–$147로 계산한다. 외곽/쉐어하우스 옵션은 재무 방어력을 높이지만, 통학 시간·안전성·룸메이트 리스크·네트워킹 시간 감소를 함께 고려해야 한다.
